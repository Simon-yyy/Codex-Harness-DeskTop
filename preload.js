...
contextBridge.exposeInMainWorld("codexDesktop", {
  ...
  importUserSkill: () => ipcRenderer.invoke("import-user-skill"),
  saveUserSkill: (payload) => ipcRenderer.invoke("save-user-skill", payload),
  deleteUserSkill: (id) => ipcRenderer.invoke("delete-user-skill", id),
  openUserSkillsDir: () => ipcRenderer.invoke("open-user-skills-dir"),
  // MCP 连接器
  listConnectors: () => ipcRenderer.invoke("connectors-list"),
  saveConnector: (payload) => ipcRenderer.invoke("connectors-save", payload),
  setConnectorEnabled: (payload) => ipcRenderer.invoke("connectors-set-enabled", payload),
  testConnector: (payload) => ipcRenderer.invoke("connectors-test", payload),
  listConnectorTools: () => ipcRenderer.invoke("connectors-list-tools"),
  callConnectorTool: (payload) => ipcRenderer.invoke("connectors-call-tool", payload),
  exportChatArtifact: (payload) => ipcRenderer.invoke("export-chat-artifact", payload),
  ...
  readWorkspaceTree: (dirPath, options) => ipcRenderer.invoke("read-workspace-tree", dirPath, options),
  readDirectoryChildren: (folderPath) => ipcRenderer.invoke("read-directory-children", folderPath),
  ...
  indexWorkspaceDocument: (relativePath) => ipcRenderer.invoke("index-workspace-document", { relativePath }),
  readDocumentChunk: (payload) => ipcRenderer.invoke("read-document-chunk", payload),
  searchDocumentChunks: (payload) => ipcRenderer.invoke("search-document-chunks", payload),
